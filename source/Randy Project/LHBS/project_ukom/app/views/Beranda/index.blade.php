...
@section("content")
        ...
        <div class="flexslider">
            ...
            <li> <img src="img/un-siswa-di-kelas.jpg" alt="" > </li>
          </ul>
            </div>
        ...
        <div class="block-slogan">
              ...
              <div>
            <p>Selamat Datang di Website "Laporan Hasil Belajar Siswa" . Disini kami menyediakan semua Laporan Hasil Belajar Siswa untuk semua sekolah yang ada di Jakarta. Anda bisa mencari nama anda disini sesuai NISN. Selamat mencoba, enjoy! </p>
          </div>
            </div>
      </div>
        </div>
