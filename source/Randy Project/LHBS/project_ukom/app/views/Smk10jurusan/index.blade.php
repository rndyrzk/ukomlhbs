    ...
    <div class="container" >
        ...
        <div>
            <h3>Jurusan</h3>
							...
							<ul>
								<li>
						<a href="{{URL::to("Rpl")}}">REKAYASA PERANGKAT LUNAK</a>
								</li>
                        <a href="{{URL::to("Sepuluhrpladmin")}}"> - Kelas X </a> <br />
                        <a href="{{URL::to("XI")}}"> - Kelas XI </a> <br />
                        <a href="{{URL::to("XII")}}"> - Kelas XII </a> <br />
							</ul>
							<ul>
								<li>
								<a href="{{URL::to("Pemasaran1")}}">PEMASARAN 1</a>
								</li>
                        <a href="{{URL::to("X")}}"> - Kelas X </a> <br />
                        <a href="{{URL::to("XI")}}"> - Kelas XI </a> <br />
                        <a href="{{URL::to("XII")}}"> - Kelas XII </a> <br />
							</ul>
							<ul>
								<li>
						<a href="{{URL::to("Pemasaran2")}}">PEMASARAN 2</a>
								</li>
                        <a href="{{URL::to("X")}}"> - Kelas X </a> <br />
                        <a href="{{URL::to("XI")}}"> - Kelas XI </a> <br />
                        <a href="{{URL::to("XII")}}"> - Kelas XII </a> <br />
							...
							<ul>
								<li>
						<a href="{{URL::to("Akutansi1")}}">AKUTANSI 1</a>
								</li>
                        <a href="{{URL::to("X")}}"> - Kelas X </a> <br />
                        <a href="{{URL::to("XI")}}"> - Kelas XI </a> <br />
                        <a href="{{URL::to("XII")}}"> - Kelas XII </a> <br />
							...
							<ul>
								<li>
						<a href="{{URL::to("Akutansi2")}}">AKUTANSI 2</a>
								</li>
                        <a href="{{URL::to("X")}}"> - Kelas X </a> <br />
                        <a href="{{URL::to("XI")}}"> - Kelas XI </a> <br />
                        <a href="{{URL::to("XII")}}"> - Kelas XII </a> <br />
							...
							<ul>
								<li>
						<a href="{{URL::to("Ap")}}">ADMINISTRASI PERKANTORAN</a>
								</li>
                        <a href="{{URL::to("X")}}"> - Kelas X </a> <br />
                        <a href="{{URL::to("XI")}}"> - Kelas XI </a> <br />
                        <a href="{{URL::to("XII")}}"> - Kelas XII </a> <br />
